...
<!-- end of the top bar -->   
    <div class="container"> 
                       <div  class="col-md-12"style="color:white;background-color:#0a4d2b;margin-top:20px;margin-bottom:30px;padding:3px;border-radius:40px;margin-right:10px;">
                                             <h2 class="text-center">Lecture Upload details</h2>
                        </div>
              
                        <div  style="background-color:white;margin-top:20px;padding:3px;border-radius:20px;margin-left:5px;">
                            
                            <form action="models/lectures_upload_backend.php" method="post" enctype="multipart/form-data" style="max-width:500px;margin:auto">
                              ...
                              <div class="input-container">
                                ...
                                <select name="subject" class="input-field" required="" id="subject">
                                 ...
                                 <div class="input-container">
                                       <i class="fa fa-user icon"></i>
                                       <input class="input-field" type="text" placeholder="Week NO" name="week">
                                     </div>
                              ...
                              <div class="input-container">
                                ...
                                <input class="input-field" type="file" name="lecture" value="Attach Your File">
                              </div>

                              <input type="submit" name="sub" class="btn" value="Upload Lecture">
                            </form>
