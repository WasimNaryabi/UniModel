                              ...
                              while($store_subject = $select2->fetch(PDO::FETCH_ASSOC)){
                                   ...
                                   <td>
                                       <div class="input-container">
                                         ...
                                         <input class="input-field" type="text" placeholder="Quiz Topic" name="topic">
                                       </div>
                                     </td>
                                   <td>
                                       <div class="input-container">
                                     
                                         <input class="input-field" type="number" placeholder="Quiz No" name="quiz_no">
                                       </div>
                                    </td>
                                   ...
                                   <td>
                                       <div class="input-container">
                                         ...
                                         <input class="input-field" type="number" placeholder="Quiz Total Marks" name="total_marks">
                                       </div>
                                     </td>
                     ...
                     <div style="background-color:white;margin-top:20px;padding:3px;border-radius:20px;margin-left:5px;">
                        ...
                        <table class="table table-responsive table-hover table-stripped" border="1">
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="<?php echo $data['student_history_id']; ?>" id="marks" placeholder="00" minlength="1" maxlength="2" size="1"></td> 
