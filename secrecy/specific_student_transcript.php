    ...
    <div class="container"> 
         ...
         <div  class="col-md-12"style="color:white;background-color:#460000;margin-top:20px;margin-bottom:30px;padding:3px;border-radius:40px;margin-right:10px;">
                 ...
                 <div  style="background-color:white;margin-top:20px;padding:3px;border-radius:20px;margin-left:5px;">
                            ...
                            <form action="models/specific_student_transcript_backend.php" method="post">
                ...
                ?>
                                ...
                                <div class="input-container">
                                    <i class="fa fa-user icon"></i>
                                    <select name="roll_number" class="input-field">
                                            <option value="0" selected="">- Select Roll <?php
                        $select_roll_number =$pdo->query("select distinct(roll_number) as roll_number from student order by roll_number asc");
                                  

                             while($show = $select_roll_number->fetch(PDO::FETCH_ASSOC)){
                    ?>   
